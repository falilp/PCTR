...
public class usalectorEscritor extends Thread{
     ...
     * @param tip Enum con el tipo de lector o escritor.
    ...
    /**
     * Método run que realizará los inicios de escritura y lectura junto a 
     * el fin de este mismo. Ademas del incremento de la variable n de la clase
     * recurso.
     */
    public void run(){
        int data = 0;
    ...
    /**
     * Método main que inicializara el monitor junto a sus hilos escritores y lectores
     * y los ejecutara.
     * @param args
     * @throws Exception
     */
